...
router.use('/job-companies', require('./job-companies'));
router.use('/job-categories', require('./job-categories'));
...
router.use('/document-categories', require('./document-categories'));
